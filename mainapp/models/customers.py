...
class Customer(DatosDeControlMixin):
    name = models.CharField(max_length=240, null=False,
                            blank=False, help_text='Customer name')
    cellphone = models.CharField(
        max_length=20, null=False, blank=False, help_text='Customer cellphone', unique=True)
    direction = models.TextField(
        null=True, blank=True, help_text='Customer direction')
    pay_method = models.CharField(
        max_length=120, null=True, blank=True, help_text='Customer pay_method')
    observations = models.TextField(
        null=True, blank=True, help_text='Customer observations')
